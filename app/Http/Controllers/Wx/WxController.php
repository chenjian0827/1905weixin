...
class WxController extends Controller
{
  ...
  <Video>
    ...
    {
        $urls ='http://1905chenjian.comcto.com/vote';
        ...
        $menu = [
            'button'    => [
                ...
                [
                    'type'  => 'view',
                    'name'  => '投票',
                    'url'   => 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx07cf75f0a11ae462&redirect_uri='.$redirect_uri.'&response_type=code&scope=snsapi_userinfo&state=ABCD1905#wechat_redirect'
                ],
            ]
        ];
